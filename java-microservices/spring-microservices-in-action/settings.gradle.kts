...
include("eureka-client-spring-cloud-load-balancer")
include("eureka-client-open-feign")
include("circuit-breaker-resilience4j")
include("circuit-breaker-resilience4j-2")
