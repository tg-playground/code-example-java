# servlet2.5-basic-04-the-response Project {{update me}}
...
```shell
$ mvn archetype:generate -DgroupId=com.taogen.example -DartifactId=servlet2.5-basic-04-the-response -DarchetypeArtifactId=maven-archetype-webapp -DinteractiveMode=false
```
...
Add package `com.taogen.example.servlet.response`

```shell
cd servlet2.5-basic-04-the-response
# Linux
mkdir -p src/main/java/com/taogen/example/servlet/response src/test/java/com/taogen/example/servlet/response
# Windows
mkdir src\main\java\com\taogen\example\servlet\response src\test\java\com\taogen\example\servlet\response
```
...
<properties>
    ...
    <tomcat.plugin.config.path>/servlet-response</tomcat.plugin.config.path>
