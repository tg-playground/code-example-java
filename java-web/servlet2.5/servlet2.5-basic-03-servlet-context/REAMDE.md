# servlet2.5-basic-03-servlet-context Project
...
```shell
$ mvn archetype:generate -DgroupId=com.taogen.example -DartifactId=servlet2.5-basic-03-servlet-context -DarchetypeArtifactId=maven-archetype-webapp -DinteractiveMode=false
```
...
Add package `com.taogen.example.servlet.servletcontext`

```shell
cd servlet2.5-basic-03-servlet-context
# Linux
mkdir -p src/main/java/com/taogen/example/servlet/servletcontext src/test/java/com/taogen/example/servlet/servletcontext
# Windows
mkdir src\main\java\com\taogen\example\servlet\servletcontext src\test\java\com\taogen\example\servlet\servletcontext
```
...
<properties>
    ...
    <tomcat.plugin.config.path>/servlet-servletcontext</tomcat.plugin.config.path>
