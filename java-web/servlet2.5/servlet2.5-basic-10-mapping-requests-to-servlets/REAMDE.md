# servlet2.5-basic-10-mapping-requests-to-servlets Project
...
```shell
$ mvn archetype:generate -DgroupId=com.taogen.example -DartifactId=servlet2.5-basic-10-mapping-requests-to-servlets -DarchetypeArtifactId=maven-archetype-webapp -DinteractiveMode=false
```
...
Add package `com.taogen.example.servlet.mapping_request`.

**<<<<<<!!{update me}!!>>>>>>**

```shell
cd servlet2.5-basic-10-mapping-requests-to-servlets
# Linux
mkdir -p src/main/java/com/taogen/example/servlet/mapping_request src/test/java/com/taogen/example/servlet/mapping_request
# Windows
mkdir src\main\java\com\taogen\example\servlet\mapping_request src\test\java\com\taogen\example\servlet\mapping_request
```
