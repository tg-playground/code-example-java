# servlet2.5-basic-02-upload-by-commons-fileupload Project
...
```shell
$ mvn archetype:generate -DgroupId=com.taogen.example -DartifactId=servlet2.5-basic-02-upload-by-commons-fileupload -DarchetypeArtifactId=maven-archetype-webapp -DinteractiveMode=false
```
    ...
    <plugins>
        ...
        <plugin>
            ...
            <configuration>
                ...
                <path>/servlet2.5-basic-02-upload-by-commons-fileupload</path>   //Configure application root URL
            </configuration>
        </plugin>
    </plugins>
  </build>
...
Add `FileUploadByCommonsFileUploadServlet.java` 
