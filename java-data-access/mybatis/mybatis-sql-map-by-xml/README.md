# mybatis-sql-map-by-xml Project
...
```shell
$ mvn archetype:generate -DgroupId=com.taogen.example.mybatis.sqlmap.xml -DartifactId=mybatis-sql-map-by-xml -DarchetypeArtifactId=maven-archetype-quickstart -DinteractiveMode=false
```
